    ...
    # If it is a POST request
        ...
        if not user_exist:
            ...
            user = User.objects.create_user(username=username, first_name=first_name, last_name=last_name,
                                            password=password)
            # Login the user and redirect index page
            login(request, user)
            return render(request,"djangoapp/index.html",{})
        else:
            return render(request, 'djangoapp/registration.html', context)
...
def get_dealerships(request):
    if request.method == "GET":
        url = "https://us-south.functions.appdomain.cloud/api/v1/web/8d60ccb3-aab5-46e0-8022-870551e76f2f/dealership-package/get-dealership"
...
def add_review(request, dealer_id):
    ...
    if request.method == 'GET':
        ...
        if (request.user.is_authenticated):
            ...
            json_result = post_request("https://us-south.functions.appdomain.cloud/api/v1/web/8d60ccb3-aab5-46e0-8022-870551e76f2f/dealership-package/post-review", review, dealerId=dealer_id)
            print(json_result)
